...
def create_comparison_plot(models_to_plot, output_filename):
    ...
    fig.suptitle('Training Performance Comparison of Models Massachusetts (mobileone_s4)', fontsize=20, y=0.98)
...
if __name__ == '__main__':
    ...
    models_to_plot = [
        {
            "name": "DeepLabV3+",
            "path": r"with_cmatrix\DeepLabV3+\plot\plot_Massachusetts_CrossEntropyLoss_DeepLabV3Plus_mobileone_s4"
        },
        {
            "name": "Unet++",
            "path": r"with_cmatrix\UNet++\plot\plot_Massachusetts_CrossEntropyLoss_UNet++_mobileone_s4"
        },
        {
            "name": "SegFormer",
            "path": r"with_cmatrix\SegFormer\plot\plot_Massachusetts_CrossEntropyLoss_SegFormer_mobileone_s4"
        }
    ]

    output_filename = "model_comparison_summary_mobileone_s4.png"
