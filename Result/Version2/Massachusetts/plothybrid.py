...
if __name__ == '__main__':
    models_to_plot = [
        {"name": "DeepLabV3Plus",
         "path": r"DeepLabV3Plus/plot/plot_Massachusetts_CrossEntropyLoss_DeepLabV3Plus_mobileone_s1"},
        {"name": "PAN", "path": r"PAN/plot/plot_Massachusetts_CrossEntropyLoss_PAN_mobileone_s1"},
        {"name": "MAnet", "path": r"MAnet/plot/plot_Massachusetts_CrossEntropyLoss_MAnet_mobileone_s1"},
        {"name": "UPerNet", "path": r"UPerNet/plot/plot_Massachusetts_CrossEntropyLoss_UPerNet_mobileone_s1"},
        {"name": "PSPNet", "path": r"PSPNet/plot/plot_Massachusetts_CrossEntropyLoss_PSPNet_mobileone_s1"},
    ]
