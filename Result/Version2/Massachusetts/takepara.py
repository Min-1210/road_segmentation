...
model_dirs = [
    r"DeepLabV3Plus/plot/plot_Massachusetts_CrossEntropyLoss_DeepLabV3Plus_mobileone_s1",
    r"PAN/plot/plot_Massachusetts_CrossEntropyLoss_PAN_mobileone_s1",
    r"MAnet/plot/plot_Massachusetts_CrossEntropyLoss_MAnet_mobileone_s1",
    r"UPerNet/plot/plot_Massachusetts_CrossEntropyLoss_UPerNet_mobileone_s1",
    r"PSPNet/plot/plot_Massachusetts_CrossEntropyLoss_PSPNet_mobileone_s1",
]
